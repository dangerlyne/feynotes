...
#userTopic = "To be mentioned by the user" < These need to be parameters

def primary(url, key, userTopic):
    idealSummary = ""
...
'''
        ...
        return("Invalid YouTube URL format! Please check the link and try again :/")
def checkAnswers(key, idealSummary, userResponse1, userResponse2, userResponse3):      
